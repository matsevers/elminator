...
open : Cmd Types.Msg
open =
    run (Types.Websocket (Types.Send Network.PredefinedMessages.openJson))


send : String -> String -> Cmd Types.Msg
send field message =
    run (Types.Websocket (Types.Send (Network.PredefinedMessages.sendJson2 field message)))


close : Cmd Types.Msg
close =
    run (Types.Websocket (Types.Send Network.PredefinedMessages.closeJson))
